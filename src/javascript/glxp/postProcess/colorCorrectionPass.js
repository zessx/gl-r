...
class PostEffect {
    ...
    initProgram() {
        ...
        let vert = require('../../../shaders/colorCorrect/colorCorrect.vert')
        let frag = require('../../../shaders/colorCorrect/colorCorrect.frag')
        ...
        shaderProgram.uStaturationUniform = gl.getUniformLocation(shaderProgram, "uStaturation")
        shaderProgram.uBrightnessUniform = gl.getUniformLocation(shaderProgram, "uBrightness")
        shaderProgram.uContrastUniform = gl.getUniformLocation(shaderProgram, "uContrast")
    ...
    render() {
        ...
        gl.uniform1f(this.program.uStaturationUniform, 1.05)        
        gl.uniform1f(this.program.uBrightnessUniform, .1)        
        gl.uniform1f(this.program.uContrastUniform, 1.1)        
