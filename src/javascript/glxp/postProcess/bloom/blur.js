...
class PostEffect {
    constructor(scene, options) {
        ...
        this.previousPass = this.options.previousPass
        this.strenght = this.options.strenght
    ...
    initProgram() {
        ...
        let frag = require('../../../../shaders/bloom/blur.frag')
        ...
        shaderProgram.uBlurStrengthUniform = gl.getUniformLocation(shaderProgram, "uBlurStrength")
