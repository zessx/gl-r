...
export class FrameRateUI {
    ...
    display_number() {
        ...
        ctx.fillStyle = this.color_selector(fps)
        ctx.fillText(raw, this.canvas.width / 2 - 10, this.canvas.height - 20);
        ctx.fillStyle = 'white'
        ctx.fillText('Dt :', this.canvas.width / 2 - 60, this.canvas.height - 20);
    }
    color_selector(fps) {
        if (fps < 20) {
            return '#E86252'
    ...
    update() {
        ...
        this.renderTime = thisLoop - this.lastLoop
